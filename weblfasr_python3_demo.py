...
class RequestApi(object):
    ...
    def get_text(self,jsonData):
        txt = ''
        for i in json.loads(jsonData.get('data')):
            txt += i.get('onebest')
        return txt
    ...
    def all_api_request(self):
        ...
        while True:
            ...
            time.sleep(20)
        # 5 . 获取结果
        return self.get_text(self.get_result_request(taskid=taskid))
...
if __name__ == '__main__':
    api = RequestApi(appid="594fa7fb", secret_key="4d2fe0943799a271f3e3db053b58f536", upload_file_path=r"c5b5a0f27591a4d4980b521630081c3d11877d57.mp3")
    print(api.all_api_request())
